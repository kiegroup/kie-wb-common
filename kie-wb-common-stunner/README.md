...
7. Paste the following into the *VM Options* field **after** editing the directory to match the location of your cloned code directory.
        ...
        -Derrai.jboss.home=/[YOUR_DIR_LOCATION]/kie-wb-common/kie-wb-common-stunner/kie-wb-common-stunner-showcase/kie-wb-common-stunner-showcase-project/target/wildfly-13.0.0.Final
