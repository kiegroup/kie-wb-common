...
public class ObserverBuilderControlTest {
    ...
    public void setup() throws Exception {
        ...
        when(graphContent.getBounds()).thenReturn(BoundsImpl.build(0d, 0d, 2400d, 1200d));
        ...
        transform = spy(new TransformImpl(new Point2D(0, 0), new Point2D(1, 1)));
        canvasView = mock(AbstractCanvas.View.class);
