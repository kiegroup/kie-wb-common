...
public class FocusableLienzoPanelWidgetView extends FocusableLienzoPanelWidget {

    private final HandlerRegistrationImpl handlerRegistrationManager;
    private FocusableLienzoPanel presenter;

    public FocusableLienzoPanelWidgetView() {
        super();
        handlerRegistrationManager = new HandlerRegistrationImpl();
        initHandlers();
    }

    public FocusableLienzoPanelWidgetView(final int width,
                                          final int height) {
    ...
    protected FocusableLienzoPanelWidgetView(final int width,
                                             final int height,
    ...
    public FocusableLienzoPanelWidgetView setPresenter(final FocusableLienzoPanel presenter) {
