...
public class ChromeFlagsWarningPopupView
    ...
    public void init(ChromeFlagsWarningPopupPresenter presenter) {
        ...
        this.flag1link.setHref(presenter.translate(ChromeFlagsWarningPopupConstants.Flag_1_URL));
        this.flag2link.setHref(presenter.translate(ChromeFlagsWarningPopupConstants.Flag_2_URL));
        this.flag3link.setHref(presenter.translate(ChromeFlagsWarningPopupConstants.Flag_3_URL));
    }

    @EventHandler("flag-1-link")
    private void onFlag1Click(final ClickEvent event) {
        presenter.copyUrlToClipboard(flag1link.getHref());
    }

    @EventHandler("flag-2-link")
    private void onFlag2Click(final ClickEvent event) {
        presenter.copyUrlToClipboard(flag2link.getHref());
    }

    @EventHandler("flag-3-link")
    private void onFlag3Click(final ClickEvent event) {
        presenter.copyUrlToClipboard(flag3link.getHref());
    }
}
