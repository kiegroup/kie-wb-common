...
public class ScreenDiagramPropertiesSwitchingSessionsEvent extends BaseSessionEvent {
    ...
    public ScreenDiagramPropertiesSwitchingSessionsEvent(final ClientSession session, final boolean isExplorerScreen) {
        super(session);
    ...
    public String toString() {
        return "ScreenDiagramPropertiesSwitchingSessionsEvent [session=" + session + "]";
    }
}
