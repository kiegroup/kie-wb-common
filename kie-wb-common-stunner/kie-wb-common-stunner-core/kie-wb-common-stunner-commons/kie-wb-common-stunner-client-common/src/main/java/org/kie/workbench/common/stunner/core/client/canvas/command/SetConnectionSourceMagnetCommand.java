...
public class SetConnectionSourceMagnetCommand extends AbstractCanvasGraphCommand {
    ...
    protected Command<GraphCommandExecutionContext, RuleViolation> newGraphCommand(final AbstractCanvasHandler context) {
        return new org.kie.workbench.common.stunner.core.graph.command.impl.SetConnectionSourceMagnetCommand(node,
                                                                                                             edge,
                                                                                                             magnetIndex,
                                                                                                             magnetX,
                                                                                                             magnetY);
