 ...
 */
@Portable
public final class SetConnectionSourceMagnetCommand extends AbstractGraphCommand {
    ...
    public SetConnectionSourceMagnetCommand(final @MapsTo("nodeUUID") String nodeUUID,
    ...
    @SuppressWarnings("unchecked")
    public SetConnectionSourceMagnetCommand(final Node<? extends View<?>, Edge> node,
    ...
    public CommandResult<RuleViolation> undo(final GraphCommandExecutionContext context) {
        final SetConnectionSourceMagnetCommand undoCommand = new SetConnectionSourceMagnetCommand((Node<? extends View<?>, Edge>) getNode(context,
                                                                                                                                          nodeUUID),
                                                                                                  getEdge(context),
                                                                                                  lastMagnetIndex,
                                                                                                  lastMagnetX,
    ...
    public String toString() {
        return "SetConnectionSourceMagnetCommand [edge=" + edgeUUID
