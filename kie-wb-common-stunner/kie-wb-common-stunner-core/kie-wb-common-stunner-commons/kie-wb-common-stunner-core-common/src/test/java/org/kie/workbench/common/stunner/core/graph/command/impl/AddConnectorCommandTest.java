...
public class AddConnectorCommandTest extends AbstractGraphCommandTest {
    ...
    public void setup() throws Exception {
        ...
        this.tested = new AddConnectorCommand( NODE_UUID, edge, 0 );
    }
    ...
    public void testAllow() {
        ...
        verify( connectionRuleManager, times( 1 ) ).evaluate( any( Edge.class ), eq( node ), any( Node.class ) );
    ...
    public void testAllowNoRules() {
        ...
        verify( containmentRuleManager, times( 0 ) ).evaluate( any( Element.class ), any( Element.class ) );
        verify( cardinalityRuleManager, times( 0 ) ).evaluate( any( Graph.class ), any( Node.class ), any( RuleManager.Operation.class ) );
        verify( connectionRuleManager, times( 0 ) ).evaluate( any( Edge.class ), eq( node ), any( Node.class ) );
    ...
    public void testExecute() {
        ...
        verify( graphIndex, times( 2 ) ).addEdge( eq( edge ) );
