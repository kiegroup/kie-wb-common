...
public class VertexPositioningTest {
    ...
    public void testRemoveToVirtualVertex() {
        ...
        final Edge edge1 = new Edge("01", "V");
        final Edge edge2 = new Edge("V", "02");
        ...
        final Edge newEdge = edges.get(0);
    ...
    public void removeEdgeBetweenVirtualVertices() {
        ...
        final Edge betweenVirtualVertices = new Edge("V2", "V3");
    ...
    public void removeAllVirtualVertices() {
        ...
        final ArrayList<Edge> edges = connect(vertices);
    ...
    private ArrayList<Edge> connect(final Vertex... vertices) {
        final ArrayList<Edge> edges = new ArrayList<>();
        for (int i = 0; i < vertices.length; i++) {

            if (i + 1 < vertices.length) {
                final Edge e = new Edge(vertices[i].getId(), vertices[i + 1].getId());
                edges.add(e);
            }
        }
        return edges;
