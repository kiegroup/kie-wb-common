...
public class ProjectDiagramEditorMenuItemsBuilder {
    ...
    public MenuItem newExportsItem(final Command exportPNGCommand,
        ...
        menu.add(new AnchorListItem(translationService.getKeyValue(CoreTranslationMessages.EXPORT_SVG)) {{
            setIcon(IconType.FILE_IMAGE_O);
            setIconPosition(IconPosition.LEFT);
            setTitle(translationService.getKeyValue(CoreTranslationMessages.EXPORT_SVG));
