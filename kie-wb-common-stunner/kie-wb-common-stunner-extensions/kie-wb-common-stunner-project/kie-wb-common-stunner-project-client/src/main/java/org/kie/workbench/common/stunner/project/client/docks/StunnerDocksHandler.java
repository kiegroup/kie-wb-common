...
public class StunnerDocksHandler extends AbstractWorkbenchDocksHandler {
    ...
    public void onCanvasSessionOpened(@Observes SessionOpenedEvent sessionOpenedEvent) {
    ...
    public void onCanvasSessionDestroyed(@Observes SessionDestroyedEvent sessionDestroyedEvent) {
    ...
    public void onCanvasSessionPaused(@Observes
    ...
    public void onCanvasSessionResumed(@Observes
                                               SessionResumedEvent sessionResumedEvent) {
        checkNotNull("sessionResumedEvent",
                     sessionResumedEvent);
