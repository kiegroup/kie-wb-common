...
@ApplicationScoped
public class DiagramEditorPreviewAndExplorerDock {
    ...
    private DefaultPlaceRequest placeRequest() {
        return new DefaultPlaceRequest(DiagramEditorExplorerScreen.SCREEN_ID);
    }
    ...
    private String dockLabel() {
        return translationService.getTranslation(SubmarineClientMessages.EXPLORER_DOCK_TITLE);
    }
}
