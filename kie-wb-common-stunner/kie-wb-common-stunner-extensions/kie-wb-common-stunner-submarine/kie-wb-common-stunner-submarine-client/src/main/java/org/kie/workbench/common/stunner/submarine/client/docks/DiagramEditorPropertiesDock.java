...
@ApplicationScoped
public class DiagramEditorPropertiesDock {
    ...
    private DefaultPlaceRequest placeRequest() {
        return new DefaultPlaceRequest(DiagramEditorPropertiesScreen.SCREEN_ID);
    }
    ...
    private String dockLabel() {
        return translationService.getTranslation(SubmarineClientMessages.PROPERTIES_DOCK_TITLE);
    }
}
