...
import static org.kie.workbench.common.stunner.cm.util.CaseManagementUtils.getCanvasChildIndex;
...
public class CaseManagementCloneCanvasNodeCommand extends CloneCanvasNodeCommand {
    ...
    public AbstractCanvasCommand createAddCanvasChildNodeCommand(Node parent, Node candidate, String shapeSetId) {
        return new CaseManagementAddChildNodeCanvasCommand(parent, candidate, shapeSetId, getCanvasChildIndex(parent, candidate));
    }
