...
//    @Before
//    public void setup() {
//        this.shape = new MockCaseManagementShapeView();
...
//        final MockCaseManagementShapeView replacement = new MockCaseManagementShapeView();
//
//        shape.add(child);
//
...
//        final MockCaseManagementShapeView child1 = new MockCaseManagementShapeView();
//        final MockCaseManagementShapeView child2 = new MockCaseManagementShapeView();
//        final MockCaseManagementShapeView replacement = new MockCaseManagementShapeView();
//
//        shape.add(child1);
//        shape.add(child2);
