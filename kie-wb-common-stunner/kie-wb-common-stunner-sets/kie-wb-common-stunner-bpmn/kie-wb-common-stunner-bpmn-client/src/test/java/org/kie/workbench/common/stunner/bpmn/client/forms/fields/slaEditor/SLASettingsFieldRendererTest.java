...
public class SLASettingsFieldRendererTest {

    @Mock
    private SLASettingsFieldEditorWidget widget;

    private SLASettingsFieldRenderer renderer;

    @Before
    public void setUp() {
        renderer = new SLASettingsFieldRenderer(widget);
    }

    @Test
    public void testGetName() {
        assertEquals("SLASettingsFieldType",
                     renderer.getName());
    }
