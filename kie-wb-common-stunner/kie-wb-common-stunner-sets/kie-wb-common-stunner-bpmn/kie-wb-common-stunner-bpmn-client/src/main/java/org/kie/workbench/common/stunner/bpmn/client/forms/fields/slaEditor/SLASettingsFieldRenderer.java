...
public class SLASettingsFieldRenderer
        extends FieldRenderer<SLASettingsFieldDefinition, DefaultFormGroup> {

    private final SLASettingsFieldEditorWidget widget;

    @Inject
    public SLASettingsFieldRenderer(final SLASettingsFieldEditorWidget widget) {
        this.widget = widget;
    }
