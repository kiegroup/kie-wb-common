...
public class RootProcessConverter
        extends BaseRootProcessConverter<BPMNDiagramImpl, DiagramSet, ProcessData, RootProcessAdvancedData> {
    ...
    @Override
    protected RootProcessAdvancedData createAdvancedData(String globalVariables, String metaDataAttributes) {
        return new RootProcessAdvancedData(new GlobalVariables(globalVariables),
                                           new MetaDataAttributes(metaDataAttributes));
    }
}
