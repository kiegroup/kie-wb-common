...
//        BPMNGraphGenerator generator = f.createBPMNGraphGenerator(baos,
//                                                        JsonEncoding.UTF8);
//        marshall(generator,
//                 def,
//                 preProcessingData);
...
//    }
     ...
     */
    public void marshall(BPMNGraphGenerator generator,
                         Definitions def,
                         String preProcessingData) throws IOException {
    ...
    /**
     * protected void marshallMessage(Message message, Definitions def, BPMNGraphGenerator generator) throws JsonGenerationException, IOException {
...
//             }
    ...
    private void writeAssociations(Process process,
                                   String elementId,
                                   BPMNGraphGenerator generator) throws IOException {
        for (Artifact artifact : process.getArtifacts()) {
            if (artifact instanceof Association) {
                Association association = (Association) artifact;
    ...
    private void writeWaypointObject(final BPMNGraphGenerator generator,
                                     final float x,
