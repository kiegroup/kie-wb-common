...
public class BackgroundSets {
    ...
    public static BackgroundSet of(BaseElement el) {
        return new BackgroundSet(
                new BgColor(Properties.findAnyAttribute(el, "bgcolor")), // or background-color
                new BorderColor(Properties.findAnyAttribute(el, "border-color")), // or bordercolor
                new BorderSize()
        );
    }
}
