...
public class BPMNDiagramMarshallerNoJson<D> implements DiagramMarshaller<Graph, Metadata, Diagram<Graph, Metadata>> {

    private static final Logger LOG = LoggerFactory.getLogger(BPMNDiagramMarshallerNoJson.class);

    private static final Class<?> DIAGRAM_DEFINITION_SET_CLASS = BPMNDefinitionSet.class;
    private static final Class<? extends BPMNDiagram> DIAGRAM_DEFINITION_CLASS = BPMNDiagramImpl.class;
    ...
    public BPMNDiagramMarshallerNoJson(final XMLEncoderDiagramMetadataMarshaller diagramMetadataMarshaller,
    ...
    public Graph unmarshall(final Metadata metadata,
        ...
        final Bpmn2UnMarshaller parser = new Bpmn2UnMarshaller(bpmnGraphBuilderFactory,
                                                               ...
                                                               commandFactory,
                                                               indexBuilder,
                                                               DIAGRAM_DEFINITION_SET_CLASS,
                                                               DIAGRAM_DEFINITION_CLASS);
        ...
        try {
            ...
            result = parser.unmarshall(definitions, null);
    ...
    private Node<Definition<BPMNDiagram>, ?> getFirstDiagramNode(final Graph graph) {
        return GraphUtils.getFirstNode(graph, DIAGRAM_DEFINITION_CLASS);
    }
