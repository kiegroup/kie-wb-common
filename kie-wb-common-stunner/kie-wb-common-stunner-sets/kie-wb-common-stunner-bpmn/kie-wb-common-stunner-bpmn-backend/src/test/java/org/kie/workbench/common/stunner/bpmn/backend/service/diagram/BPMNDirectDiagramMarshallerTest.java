...
public class BPMNDirectDiagramMarshallerTest {
    ...
    public void testMarshallMultipleInstanceSubprocess() throws Exception {
        ...
        assertTrue(result.contains("<bpmn2:loopDataInputRef>var1</bpmn2:loopDataInputRef>"));
        assertTrue(result.contains("<bpmn2:loopDataOutputRef>var2</bpmn2:loopDataOutputRef>"));
