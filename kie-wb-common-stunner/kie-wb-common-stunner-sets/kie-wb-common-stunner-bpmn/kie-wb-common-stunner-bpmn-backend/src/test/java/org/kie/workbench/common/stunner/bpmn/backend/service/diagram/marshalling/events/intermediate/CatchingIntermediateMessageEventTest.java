...
public class CatchingIntermediateMessageEventTest extends CatchingIntermediateEvent<IntermediateMessageEventCatching> {
    ...
    public void testUnmarshallTopLevelEventFilledProperties() throws Exception {
        ...
        IntermediateMessageEventCatching filledTopEvent = getCatchingIntermediateNodeById(diagram, FILLED_TOP_LEVEL_EVENT_ID,
                                                                                          IntermediateMessageEventCatching.class, HAS_NOT_INCOME_EDGE);
    ...
    public void testUnmarshallTopLevelEmptyEventProperties() throws Exception {
        ...
        IntermediateMessageEventCatching emptyTopEvent = getCatchingIntermediateNodeById(diagram, EMPTY_TOP_LEVEL_EVENT_ID,
                                                                                         IntermediateMessageEventCatching.class, HAS_NOT_INCOME_EDGE);
    ...
    public void testUnmarshallSubprocessLevelEventFilledProperties() throws Exception {
        ...
        IntermediateMessageEventCatching filledSubprocessEvent = getCatchingIntermediateNodeById(diagram, FILLED_SUBPROCESS_LEVEL_EVENT_ID,
                                                                                                 IntermediateMessageEventCatching.class, HAS_NOT_INCOME_EDGE);
    ...
    public void testUnmarshallSubprocessLevelEventEmptyProperties() throws Exception {
        ...
        IntermediateMessageEventCatching emptySubprocessEvent = getCatchingIntermediateNodeById(diagram, EMPTY_SUBPROCESS_LEVEL_EVENT_ID,
                                                                                                IntermediateMessageEventCatching.class, HAS_NOT_INCOME_EDGE);
    ...
    public void testUnmarshallTopLevelEventWithIncomeFilledProperties() throws Exception {
        ...
        IntermediateMessageEventCatching filledSubprocessEvent = getCatchingIntermediateNodeById(diagram, FILLED_WITH_INCOME_TOP_LEVEL_EVENT_ID,
                                                                                                 IntermediateMessageEventCatching.class, HAS_INCOME_EDGE);
        assertGeneralSet(filledSubprocessEvent.getGeneral(), EVENT_NAME, EVENT_DOCUMENTATION);
        assertMessageEventExecutionSet(filledSubprocessEvent.getExecutionSet(), EVENT_REF, CANCELLING);
        assertDataIOSet(filledSubprocessEvent.getDataIOSet(), EVENT_DATA_OUTPUT);
    }
    ...
    public void testUnmarshallTopLevelEventWithIncomeEmptyProperties() throws Exception {
        ...
        IntermediateMessageEventCatching emptyEvent = getCatchingIntermediateNodeById(diagram, EMPTY_WITH_INCOME_TOP_LEVEL_EVENT_ID,
                                                                                      IntermediateMessageEventCatching.class, HAS_INCOME_EDGE);
    ...
    public void testUnmarshallSubprocessLevelEventWithIncomeEmptyProperties() throws Exception {
        ...
        IntermediateMessageEventCatching emptySubprocessEvent = getCatchingIntermediateNodeById(diagram, EMPTY_WITH_INCOME_SUBPROCESS_LEVEL_EVENT_ID,
                                                                                                IntermediateMessageEventCatching.class, HAS_INCOME_EDGE);
        assertGeneralSet(emptySubprocessEvent.getGeneral(), EMPTY_VALUE, EMPTY_VALUE);
        assertMessageEventExecutionSet(emptySubprocessEvent.getExecutionSet(), EMPTY_VALUE, CANCELLING);
        assertDataIOSet(emptySubprocessEvent.getDataIOSet(), EMPTY_VALUE);
    ...
    public void testUnmarshallSubprocessLevelEventWithIncomeFilledProperties() throws Exception {
        ...
        IntermediateMessageEventCatching filledSubprocessEvent = getCatchingIntermediateNodeById(diagram, FILLED_WITH_INCOME_SUBPROCESS_LEVEL_EVENT_ID,
                                                                                                 IntermediateMessageEventCatching.class, HAS_INCOME_EDGE);
        assertGeneralSet(filledSubprocessEvent.getGeneral(), EVENT_NAME, EVENT_DOCUMENTATION);
        assertMessageEventExecutionSet(filledSubprocessEvent.getExecutionSet(), EVENT_REF, CANCELLING);
        assertDataIOSet(filledSubprocessEvent.getDataIOSet(), EVENT_DATA_OUTPUT);
