...
public class StartSignalEventTest extends StartEvent {
    ...
    public void testMarshallTopLevelEventFilledProperties() throws Exception {
        ...
        assertNodesEqualsAfterMarshalling(initialDiagram, marshalledDiagram, FILLED_TOP_LEVEL_EVENT_ID, StartSignalEvent.class);
    }
    ...
    public void testMarshallTopLevelEmptyEventProperties() throws Exception {
        ...
        assertNodesEqualsAfterMarshalling(initialDiagram, marshalledDiagram, EMPTY_TOP_LEVEL_EVENT_ID, StartSignalEvent.class);
    }
    ...
    public void testMarshallSubprocessLevelEventFilledProperties() throws Exception {
        ...
        assertNodesEqualsAfterMarshalling(initialDiagram, marshalledDiagram, FILLED_SUBPROCESS_LEVEL_EVENT_ID, StartSignalEvent.class);
    }
