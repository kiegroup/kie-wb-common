...
import org.kie.workbench.common.stunner.bpmn.shape.def.StartTimerEventShapeDef;
...
@Shape(factory = BasicShapesFactory.class, def = StartTimerEventShapeDef.class)
