...
@Dependent
public class TimerSettingsFieldInitializer implements FieldInitializer<TimerSettingsFieldDefinition> {

    @Override
    public boolean supports(FieldDefinition fieldDefinition) {
        return fieldDefinition instanceof TimerSettingsFieldDefinition;
    }

    @Override
    public void initialize(TimerSettingsFieldDefinition field,
