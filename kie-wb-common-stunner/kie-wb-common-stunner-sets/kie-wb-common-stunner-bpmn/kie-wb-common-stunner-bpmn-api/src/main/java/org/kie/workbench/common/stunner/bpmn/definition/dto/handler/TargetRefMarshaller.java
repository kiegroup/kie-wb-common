...
public class TargetRefMarshaller extends CustomXMLSerializer<TargetRef> {

    @Override
    protected void doSerialize(
            XMLWriter writer, TargetRef value, XMLSerializationContext ctx, XMLSerializerParameters params)
            throws XMLStreamException {
        writer.beginObject("bpmn2:targetRef");
        if (value.isAsCDATA()) {
