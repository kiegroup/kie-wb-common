...
public class TargetRefDemarshaller extends CustomXMLDeserializer<TargetRef> {

    @Override
    protected TargetRef doDeserialize(
            XMLReader reader, XMLDeserializationContext ctx, XMLDeserializerParameters params)
            throws XMLStreamException {
        TargetRef result = new TargetRef();
        reader.next();
