...
@Dependent
public class SLASettingsFieldInitializer implements FieldInitializer<SLASettingsFieldDefinition> {

    @Override
    public boolean supports(FieldDefinition fieldDefinition) {
        return fieldDefinition instanceof SLASettingsFieldDefinition;
    }

    @Override
    public void initialize(SLASettingsFieldDefinition field,
