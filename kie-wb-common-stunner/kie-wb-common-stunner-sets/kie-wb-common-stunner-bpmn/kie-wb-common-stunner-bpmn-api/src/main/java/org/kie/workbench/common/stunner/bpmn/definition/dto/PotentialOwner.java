...
@XmlRootElement(name = "potentialOwner", namespace = "http://www.omg.org/spec/BPMN/20100524/MODEL")
public class PotentialOwner {
    ...
    public PotentialOwner(String id, ResourceAssignmentExpression expression) {
        this.id = id;
        this.resourceAssignmentExpression = expression;
    }
