...
public class ProcessTypeMarshaller extends CustomXMLSerializer<ProcessType> {

    @Override
    protected void doSerialize(
            XMLWriter writer, ProcessType value, XMLSerializationContext ctx, XMLSerializerParameters params)
