...
public class VersionMarshaller extends CustomXMLSerializer<Version> {

    @Override
    protected void doSerialize(
            XMLWriter writer, Version value, XMLSerializationContext ctx, XMLSerializerParameters params)
