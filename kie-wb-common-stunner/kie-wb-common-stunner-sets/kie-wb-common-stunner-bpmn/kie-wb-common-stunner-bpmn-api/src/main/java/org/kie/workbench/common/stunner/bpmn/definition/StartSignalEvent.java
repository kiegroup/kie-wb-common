...
import org.kie.workbench.common.stunner.bpmn.shape.def.StartSignalEventShapeDef;
...
@Shape(factory = BasicShapesFactory.class, def = StartSignalEventShapeDef.class)
