...
public class StringValueMarshaller extends CustomXMLSerializer<StringValue> {

    @Override
    protected void doSerialize(
            XMLWriter writer, StringValue value, XMLSerializationContext ctx, XMLSerializerParameters params)
            throws XMLStreamException {
        writer.beginObject("bpmn2:" + propertyName);
