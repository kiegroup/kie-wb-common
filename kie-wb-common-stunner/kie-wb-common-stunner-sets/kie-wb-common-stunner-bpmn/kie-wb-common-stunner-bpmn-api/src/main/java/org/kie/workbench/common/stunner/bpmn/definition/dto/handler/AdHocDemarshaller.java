...
public class AdHocDemarshaller extends CustomXMLDeserializer<AdHoc> {

    @Override
    protected AdHoc doDeserialize(
            XMLReader reader, XMLDeserializationContext ctx, XMLDeserializerParameters params)
            throws XMLStreamException {
        return new AdHoc(Boolean.parseBoolean(reader.nextString()));
    }

    @Override
    public AdHoc deserialize(
            String value, XMLDeserializationContext ctx, XMLDeserializerParameters params)
            throws XMLDeserializationException {
        return new AdHoc(Boolean.parseBoolean(value));
    }
}