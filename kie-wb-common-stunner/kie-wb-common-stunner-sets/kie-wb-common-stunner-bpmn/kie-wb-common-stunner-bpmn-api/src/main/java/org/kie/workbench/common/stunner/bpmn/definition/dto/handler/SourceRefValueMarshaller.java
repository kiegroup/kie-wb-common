...
public class SourceRefValueMarshaller extends CustomXMLSerializer<SourceRef> {

    @Override
    protected void doSerialize(
            XMLWriter writer, SourceRef value, XMLSerializationContext ctx, XMLSerializerParameters params)
            throws XMLStreamException {
        writer.beginObject("bpmn2:sourceRef");
