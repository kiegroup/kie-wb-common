...
public class DocumentationDemarshaller extends CustomXMLDeserializer<Documentation> {

    @Override
    protected Documentation doDeserialize(
            XMLReader reader, XMLDeserializationContext ctx, XMLDeserializerParameters params)
            throws XMLStreamException {
        return new Documentation(reader.nextString());
    }

    @Override
    public Documentation deserialize(
