...
public class FormalExpressionDemarshaller extends CustomXMLDeserializer<FormalExpression.FormalExpressionValue> {

    @Override
    protected FormalExpression.FormalExpressionValue doDeserialize(
            XMLReader reader, XMLDeserializationContext ctx, XMLDeserializerParameters params)
            throws XMLStreamException {
        return new FormalExpression.FormalExpressionValue(reader.nextString());
    }

    @Override
    public FormalExpression.FormalExpressionValue deserialize(
            String value, XMLDeserializationContext ctx, XMLDeserializerParameters params)
            throws XMLDeserializationException {
        return new FormalExpression.FormalExpressionValue(value);
    }
}
