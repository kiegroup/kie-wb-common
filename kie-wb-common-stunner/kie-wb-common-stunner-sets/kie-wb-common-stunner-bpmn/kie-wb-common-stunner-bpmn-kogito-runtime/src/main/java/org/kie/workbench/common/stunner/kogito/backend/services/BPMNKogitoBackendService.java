...
@ApplicationScoped
public class BPMNKogitoBackendService extends AbstractDefinitionSetService {

    private final BPMNDefinitionSetResourceType bpmnResourceType;

    protected BPMNKogitoBackendService() {
        this(null,
             null);
    }

    @Inject
    public BPMNKogitoBackendService(
            final KogitoDiagramRepresentationMarshaller marshaller,
