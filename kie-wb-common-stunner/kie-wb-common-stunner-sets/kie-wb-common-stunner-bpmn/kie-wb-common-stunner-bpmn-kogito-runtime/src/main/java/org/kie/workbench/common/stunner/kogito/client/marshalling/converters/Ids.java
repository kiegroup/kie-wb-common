...
package org.kie.workbench.common.stunner.kogito.client.marshalling.converters;
...
public class Ids {
    ...
    public static String inCollectionInput(String parentId) {
        return parentId + "_IN_COLLECTIONInputX";
    }

    public static String outCollectionOutput(String parentId) {
        return parentId + "_OUT_COLLECTIONOutputX";
    }
