...
public class ImportsWidgetViewImplTest {
    ...
    @Test
    public void setContentOrdersImportsByInternalThenExternalAlphabetically() {
    ...
    @Test
    public void checkAddImportSortsItems() {
    ...
    @Test
    public void checkRemoveImportSortsRemainingItems() {
