...
public class WorkbenchConfigurationPopup extends BaseModal {
        ...
        preferencesService.call( new RemoteCallback<UserWorkbenchPreferences>() {
            ...
            public void callback( final UserWorkbenchPreferences response ) {
                if (response != null) {
                    ...
                    contextualView.setOldCurrentLocaleLanguage( LocaleInfo.getCurrentLocale().getLocaleName() );
    ...
    private void refresh( final String selectedLanguageItem , final String selectedMultipleMode , final UserWorkbenchPreferences response ) {
        ...
        if (response != null && contextualView.getOldCurrentLocaleLanguage() != null && contextualView.getCurrentLocaleLanguage() != null && contextualView.getCurrentLocaleLanguage().equals( contextualView.getOldCurrentLocaleLanguage() )) {
            refreshWorkbenchFlag = false;
        }
    ...
    private void refreshWorkbench( final String selectedLanguageItem , boolean refreshWorkbenchFlag ) {
        ...
        if (selectedLanguageItem == null || selectedLanguageItem.equals( "" )) {
            ...
            contextualView.setCurrentLocaleLanguage( selectedLanguageItem );
