...
public class Promises {
    ...
    public <V, T> Promise<T> catchOrExecute(final Object o,
        ...
        if (o instanceof JavaScriptObject) {
            ...
            return c.apply(new RuntimeException("Client-side exception: " + o.toString())); //FIXME: Maybe this loses stacktraces?
        }

        if (o instanceof RuntimeException) {
            return c.apply((RuntimeException) o); //FIXME: Client-side error inside Promise
        }

        if (o instanceof Promises.Error) {
            final Promises.Error error = (Promises.Error) o;
            return c.apply((RuntimeException) error.getThrowable()).catch_(e -> {
