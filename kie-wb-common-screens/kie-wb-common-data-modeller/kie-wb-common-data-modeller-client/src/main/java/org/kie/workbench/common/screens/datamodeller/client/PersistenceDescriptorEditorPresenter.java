...
public class PersistenceDescriptorEditorPresenter
    ...
    private RemoteCallback<List<BuildMessage>> getValidationSuccessCallback() {
        return new RemoteCallback<List<BuildMessage>>() {
            @Override
            public void callback(List<BuildMessage> messages) {
