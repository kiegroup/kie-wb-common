...
import static org.kie.workbench.common.screens.datamodeller.backend.server.validation.PersistenceDescriptorValidationMessages.newWarningMessage;
...
public class PropertyValidatorTest {
    ...
    public void testValidateValidProperties() {
        ...
        List<BuildMessage> result = validator.validate(PROPERTY_NAME, "value");
    ...
    public void testValidateInvalidProperties() {
        ...
        List<BuildMessage> result = validator.validate("", "value");
        assertEquals(1, result.size());
        BuildMessage expectedMessage = newErrorMessage(PersistenceDescriptorValidationMessages.PROPERTY_NAME_EMPTY_ID,
