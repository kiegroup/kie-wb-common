...
public interface DataModelerService {
    ...
    List<BuildMessage> validate(String source, final Path path, DataObject dataObject);
    ...
    List<BuildMessage> validateValuePair(String annotationClassName, ElementType target, String valuePairName,
                                         String literalValue);
