...
public class ProcessConfigPresenterTest {
    ...
    public void testCancel() {
        final ProcessConfig processConfig = new ProcessConfig( ClientRuntimeStrategy.PER_REQUEST.toString(),
                                                               "kBase",
                                                               "kSession",
        ...
        verify( view, times( 2 ) ).setContent( ClientRuntimeStrategy.PER_REQUEST.getValue( translationService ),
    ...
    public void testSetup() {
        ...
        final ProcessConfig processConfig = new ProcessConfig( ClientRuntimeStrategy.PER_REQUEST.toString(), "kBase", "kSession", ClientMergeMode.KEEP_ALL.toString() );
        presenter.setup( containerSpecKey, processConfig );

        verify( view ).setContent( ClientRuntimeStrategy.PER_REQUEST.getValue( translationService ),
                                   processConfig.getKBase(),
                                   processConfig.getKSession(),
