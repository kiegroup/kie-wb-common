...
public class DefaultDriverInitializerImpl
    ...
    private void initializeFromProperties( Properties properties ) {
        ...
        for ( String driverCode : driverCodes ) {
            ...
            if ( ( value = getDriverParam( properties, UUID, driverCode ) ) != null ) {
                driverDef.setUuid( value );
            } else {
                break;
            }
            if ( ( value = getDriverParam( properties, NAME, driverCode ) ) != null ) {
                driverDef.setName( value );
            } else {
                break;
            }
            if ( ( value = getDriverParam( properties, DRIVER_CLASS, driverCode ) ) != null ) {
                driverDef.setDriverClass( value );
            } else {
                break;
            }
            if ( ( value = getDriverParam( properties, GROUP_ID, driverCode ) ) != null ) {
                driverDef.setGroupId( value );
            } else {
                break;
            }
            if ( ( value = getDriverParam( properties, ARTIFACT_ID, driverCode ) ) != null ) {
                driverDef.setArtifactId( value );
            } else {
                break;
            }
            if ( ( value = getDriverParam( properties, VERSION, driverCode ) ) != null ) {
