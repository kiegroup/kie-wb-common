...
public class BooleanLOVInputFieldDefinitionTest extends AbstractFieldDefinitionTest<BooleanLOVFieldDefinition> {

    @Override
    protected BooleanLOVFieldDefinition getEmptyFieldDefinition() {
        return new BooleanLOVFieldDefinition();
    }

    @Override
    protected BooleanLOVFieldDefinition getFullFieldDefinition() {
        BooleanLOVFieldDefinition fieldDefinition = new BooleanLOVFieldDefinition();
