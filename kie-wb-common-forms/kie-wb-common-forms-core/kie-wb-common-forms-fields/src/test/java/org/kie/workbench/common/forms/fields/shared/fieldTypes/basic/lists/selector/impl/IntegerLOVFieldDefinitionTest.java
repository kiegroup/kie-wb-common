...
public class IntegerLOVFieldDefinitionTest extends AbstractFieldDefinitionTest<IntegerLOVFieldDefinition> {

    @Override
    protected IntegerLOVFieldDefinition getEmptyFieldDefinition() {
        return new IntegerLOVFieldDefinition();
    }

    @Override
    protected IntegerLOVFieldDefinition getFullFieldDefinition() {
        IntegerLOVFieldDefinition fieldDefinition = new IntegerLOVFieldDefinition();
