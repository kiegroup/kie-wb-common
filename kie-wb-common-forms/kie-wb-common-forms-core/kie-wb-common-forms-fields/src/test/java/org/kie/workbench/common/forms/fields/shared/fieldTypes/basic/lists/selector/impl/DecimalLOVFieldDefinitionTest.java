...
public class DecimalLOVFieldDefinitionTest extends AbstractFieldDefinitionTest<DecimalLOVFieldDefinition> {

    @Override
    protected DecimalLOVFieldDefinition getEmptyFieldDefinition() {
        return new DecimalLOVFieldDefinition();
    }

    @Override
    protected DecimalLOVFieldDefinition getFullFieldDefinition() {
        DecimalLOVFieldDefinition fieldDefinition = new DecimalLOVFieldDefinition();
