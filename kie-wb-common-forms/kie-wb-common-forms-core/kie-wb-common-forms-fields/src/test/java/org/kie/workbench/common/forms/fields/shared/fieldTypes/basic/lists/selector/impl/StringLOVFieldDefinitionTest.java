...
public class StringLOVFieldDefinitionTest extends AbstractFieldDefinitionTest<StringLOVFieldDefinition> {

    @Override
    protected StringLOVFieldDefinition getEmptyFieldDefinition() {
        return new StringLOVFieldDefinition();
    }

    @Override
    protected StringLOVFieldDefinition getFullFieldDefinition() {
        StringLOVFieldDefinition fieldDefinition = new StringLOVFieldDefinition();
