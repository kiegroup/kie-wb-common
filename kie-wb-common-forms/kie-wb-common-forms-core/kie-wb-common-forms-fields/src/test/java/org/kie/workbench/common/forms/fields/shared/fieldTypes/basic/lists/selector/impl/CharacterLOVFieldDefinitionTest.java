...
public class CharacterLOVFieldDefinitionTest extends AbstractFieldDefinitionTest<CharacterLOVFieldDefinition> {

    @Override
    protected CharacterLOVFieldDefinition getEmptyFieldDefinition() {
        return new CharacterLOVFieldDefinition();
    }

    @Override
    protected CharacterLOVFieldDefinition getFullFieldDefinition() {
        CharacterLOVFieldDefinition fieldDefinition = new CharacterLOVFieldDefinition();
