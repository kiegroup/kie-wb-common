...
public class DateLOVFieldDefinitionTest extends AbstractFieldDefinitionTest<DateLOVFieldDefinition> {

    @Override
    protected DateLOVFieldDefinition getEmptyFieldDefinition() {
        return new DateLOVFieldDefinition();
    }

    @Override
    protected DateLOVFieldDefinition getFullFieldDefinition() {
        DateLOVFieldDefinition fieldDefinition = new DateLOVFieldDefinition();
