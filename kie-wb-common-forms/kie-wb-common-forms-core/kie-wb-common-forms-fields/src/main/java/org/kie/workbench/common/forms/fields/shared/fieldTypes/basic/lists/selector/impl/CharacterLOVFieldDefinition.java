...
public class CharacterLOVFieldDefinition extends AbstractLOVSelectorFieldDefinition<Character> {

    @FormField(
            type = LOVInputFieldType.class,
            labelKey = "listOfValues",
            afterElement = "allowClearSelection"
    )
    private List<Character> listOfValues = new ArrayList<>();

    public CharacterLOVFieldDefinition() {
