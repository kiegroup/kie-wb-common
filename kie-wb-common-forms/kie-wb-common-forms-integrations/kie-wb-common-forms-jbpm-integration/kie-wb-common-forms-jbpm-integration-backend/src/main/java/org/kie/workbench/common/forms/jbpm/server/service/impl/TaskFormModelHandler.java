...
public class TaskFormModelHandler extends AbstractJBPMFormModelHandler<TaskFormModel> {
    ...
    protected static final String MISSING_PROCESS_SHORT_KEY = "MissingTask.shortMessage";
    protected static final String MISSING_PROCESS_FULL_KEY = "MissingTask.fullMessage";
