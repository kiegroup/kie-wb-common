...
@Templated
public class LOVSelectorInputViewImpl<TYPE> extends Composite implements LOVSelectorInputView<TYPE> {
    ...
    public void setPresenter(Presenter presenter) {
        ...
        DOMUtil.appendWidgetToElement(selector, presenter.getSelector());
    }
