...
public class BigIntegerListToLongListConverter implements Converter<List, List> {
    ...
    @Override
    public List<BigInteger> toModelValue(List componentValue) {
    ...
    public List<Long> toWidgetValue(List modelValue) {
        ...
        List<BigInteger> bigIntegerList = modelValue;

        return bigIntegerList.stream().map(bigIntegerValue -> {
