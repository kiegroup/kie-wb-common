...
import org.kie.workbench.common.forms.dynamic.client.rendering.renderers.lov.creator.input.widget.LOVCreationComponent;

@Dependent
public class LOVCreationInput<TYPE> implements IsWidget,
                                               LOVCreationInputView.Presenter<TYPE> {

    private LOVCreationInputView<TYPE> view;

    private LOVCreationComponent<TYPE> component;

    @Inject
    public LOVCreationInput(LOVCreationInputView<TYPE> view, LOVCreationComponent<TYPE> component) {
        this.view = view;
    ...
    @Override
    public LOVCreationComponent getComponent() {
        return component;
    }
