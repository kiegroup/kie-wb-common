...
@Dependent
public class LOVSelectorInput<TYPE> implements IsWidget,
                                               LOVSelectorInputView.Presenter<TYPE> {

    private LOVSelectorInputView<TYPE> view;
    ...
    @Inject
    public LOVSelectorInput(LOVSelectorInputView view,
