...
public class IntegerListToLongListConverter implements Converter<List, List> {
    ...
    @Override
    public List<Integer> toModelValue(List componentValue) {
    ...
    public List<Long> toWidgetValue(List modelValue) {
        ...
        List<Integer> integersList = modelValue;

        return integersList.stream().map(intValue -> {
            if(intValue == null) {
                return null;
            }
