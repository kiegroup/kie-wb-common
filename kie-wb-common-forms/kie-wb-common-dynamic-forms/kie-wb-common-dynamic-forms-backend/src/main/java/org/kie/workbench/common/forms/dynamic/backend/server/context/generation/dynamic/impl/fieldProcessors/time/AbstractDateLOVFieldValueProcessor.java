...
public abstract class AbstractDateLOVFieldValueProcessor<F extends FieldDefinition> implements FieldValueProcessor<F, List<?>, List<Date>> {

    private LocalDateFieldValueProcessor localDateFieldValueProcessor;

    public AbstractDateLOVFieldValueProcessor(LocalDateFieldValueProcessor localDateFieldValueProcessor) {
