...
public class DynamicPersistenceUnitInfoImpl implements PersistenceUnitInfo {
    ...
    public DynamicPersistenceUnitInfoImpl(String jpaVersion,
                                          String unitName,
    ...
    public DynamicPersistenceUnitInfoImpl setJtaDataSource(
    ...
    public DynamicPersistenceUnitInfoImpl setNonJtaDataSource(
