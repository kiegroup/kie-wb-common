...
public class MergeInstanceCommand extends AbstractPersistenceCommand<Object> {

    private Object instance;

    public MergeInstanceCommand(Object instance) {
    ...
    protected Object doExecute(JPATransactionHandler transactionHandler) {
        ...
        return transactionHandler.getEntityManager().merge(instance);
    }
}
