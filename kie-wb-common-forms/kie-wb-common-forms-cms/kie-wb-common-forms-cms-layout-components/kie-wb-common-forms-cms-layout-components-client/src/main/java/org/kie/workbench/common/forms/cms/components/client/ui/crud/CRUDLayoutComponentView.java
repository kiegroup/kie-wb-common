...
public interface CRUDLayoutComponentView extends UberElement<CRUDLayoutComponentView.Presenter> {

    CrudComponent getCRUD();

    void showCRUD();

    void showForm(FormRenderingContext context,
                  Command onSubmit,
                  Command onCancel);
