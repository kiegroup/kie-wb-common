...
@Dependent
public class FakeFeatureDefinition3 implements ExperimentalFeatureDefinition {

    public static final String DATA_MANAGEMENT_FEATURE_KEY = "More cool features you can use...";
