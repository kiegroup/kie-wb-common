...
public class FormGenerationTest_DataObject implements java.io.Serializable {
    ...
    private bpms.new_formmodeler.FormGenerationTest_NestedObject nestedObjectForSubform;

    @javax.persistence.OneToMany(cascade = {javax.persistence.CascadeType.ALL}, fetch = javax.persistence.FetchType.EAGER)
    private java.util.List<bpms.new_formmodeler.FormGenerationTest_NestedObject> nestedObjectListForMultipleSubform;
    ...
    public bpms.new_formmodeler.FormGenerationTest_NestedObject getNestedObjectForSubform() {
        return this.nestedObjectForSubform;
    }

    public void setNestedObjectForSubform(
            bpms.new_formmodeler.FormGenerationTest_NestedObject nestedObjectForSubform) {
        this.nestedObjectForSubform = nestedObjectForSubform;
    }

    public java.util.List<bpms.new_formmodeler.FormGenerationTest_NestedObject> getNestedObjectListForMultipleSubform() {
        return this.nestedObjectListForMultipleSubform;
    }

    public void setNestedObjectListForMultipleSubform(
            java.util.List<bpms.new_formmodeler.FormGenerationTest_NestedObject> nestedObjectListForMultipleSubform) {
