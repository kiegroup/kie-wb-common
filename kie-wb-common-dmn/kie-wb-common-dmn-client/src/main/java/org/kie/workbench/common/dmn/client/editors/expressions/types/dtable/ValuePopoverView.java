...
public interface ValuePopoverView extends PopoverView,
                                          UberElement<ValuePopoverView.Presenter>,
                                          CanBeClosedByKeyboard {

    interface Presenter extends HasCellEditorControls.Editor<HasValueSelectorControl>,
                                CanBeClosedByKeyboard {
