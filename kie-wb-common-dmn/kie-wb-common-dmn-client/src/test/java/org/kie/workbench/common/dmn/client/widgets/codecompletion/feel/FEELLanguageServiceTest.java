...
public class FEELLanguageServiceTest {
    ...
    private List<FunctionOverrideVariation> getFunctionOverrideVariations() {
        return asList(
                new FunctionOverrideVariation(BuiltInType.NUMBER,
                                              "org.kie.dmn.feel.runtime.functions.AbsFunction",
                                              "abs",
                                              new Parameter("duration", java.time.Duration.class, BuiltInType.DURATION)),
                new FunctionOverrideVariation(BuiltInType.NUMBER,
                                              "org.kie.dmn.feel.runtime.functions.AbsFunction",
                                              "abs",
                                              new Parameter("number", java.math.BigDecimal.class, BuiltInType.NUMBER)),
                new FunctionOverrideVariation(BuiltInType.BOOLEAN,
                                              "org.kie.dmn.feel.runtime.functions.twovaluelogic.NNAnyFunction",
                                              "any", new Parameter("list", java.util.List.class, BuiltInType.LIST)),
                new FunctionOverrideVariation(BuiltInType.DATE,
                                              "org.kie.dmn.feel.runtime.functions.DateFunction",
                                              "date",
                                              new Parameter("from", java.time.temporal.TemporalAccessor.class, BuiltInType.STRING)),
                new FunctionOverrideVariation(BuiltInType.DATE,
                                              "org.kie.dmn.feel.runtime.functions.DateFunction",
                                              "date",
                                              new Parameter("year", java.lang.Number.class, BuiltInType.NUMBER),
                                              new Parameter("month", java.lang.Number.class, BuiltInType.NUMBER),
                                              new Parameter("day", java.lang.Number.class, BuiltInType.NUMBER)),
                new FunctionOverrideVariation(BuiltInType.DATE,
                                              "org.kie.dmn.feel.runtime.functions.extended.NowFunction",
                                              "now"),
                new FunctionOverrideVariation(BuiltInType.NUMBER,
                                              "org.kie.dmn.feel.runtime.functions.SumFunction",
                                              "sum",
                                              new Parameter("list", java.util.List.class, BuiltInType.LIST)),
                new FunctionOverrideVariation(BuiltInType.STRING,
                                              "org.kie.dmn.feel.runtime.functions.StringFunction",
                                              "string",
                                              new Parameter("from", java.time.temporal.TemporalAccessor.class, BuiltInType.NUMBER))
        );
    }
}
