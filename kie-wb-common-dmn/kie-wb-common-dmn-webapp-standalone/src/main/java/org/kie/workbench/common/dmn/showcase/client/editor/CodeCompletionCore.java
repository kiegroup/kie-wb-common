 ...
 */
package org.kie.workbench.common.dmn.showcase.client.editor; // TODO changed the package
// TODO DO NOT MERGE THIS IN AS IT IS THE LICENSE IS WRONG AND THIS IS FRON antlr-c3!
...
//    private final CandidatesCollection candidates = new CandidatesCollection(); // The collected candidates (rules and tokens).
     final CandidatesCollection candidates = new CandidatesCollection(); // The collected candidates (rules and tokens).
