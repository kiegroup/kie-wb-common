...
public class LRUDataModelOracleCache extends LRUCache<Package, PackageDataModelOracle> {
    ...
    public synchronized void invalidateModulePackagesCache(@Observes final InvalidateDMOModuleCacheEvent event) {
        PortablePreconditions.checkNotNull("event",
                                           event);
        final Path resourcePath = event.getResourcePath();
    ...
    public synchronized PackageDataModelOracle assertPackageDataModelOracle(final KieModule module,
                                                                            final Package pkg) {
