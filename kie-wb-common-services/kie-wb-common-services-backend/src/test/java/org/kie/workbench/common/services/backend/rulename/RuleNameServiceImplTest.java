...
public class RuleNameServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        when( appConfigService.loadPreferences() ).thenReturn( Collections.EMPTY_MAP );

        service = new RuleNameServiceImpl( sourceServices, projectService, ioService, appConfigService );
    }
