 ...
 */
@Component(role = ConfigurationProcessor.class, hint = AFBaseConfigurationProcessor.HINT)
public class AFBaseConfigurationProcessor implements AFConfigurationProcessor {
    ...
    public AFBaseConfigurationProcessor(Path userHome,
                                        Path mavenHome) {
        USER_HOME = userHome;
