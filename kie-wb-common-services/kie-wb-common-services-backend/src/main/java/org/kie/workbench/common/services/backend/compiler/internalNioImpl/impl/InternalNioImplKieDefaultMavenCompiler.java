...
public class InternalNioImplKieDefaultMavenCompiler extends InternalNioImplDefaultMavenCompiler implements InternalNioImplMavenCompiler{

    @Override
    public KieCompilationResponse compileSync(InternalNioImplCompilationRequest req) {
