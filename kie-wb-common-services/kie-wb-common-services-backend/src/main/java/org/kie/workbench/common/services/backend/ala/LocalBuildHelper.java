...
public class LocalBuildHelper {
    ...
    private static final Logger logger = LoggerFactory.getLogger( LocalBuildHelper.class );
    ...
    public LocalBuildHelper( ) {
    }

    @Inject
    public LocalBuildHelper( final POMService pomService,
