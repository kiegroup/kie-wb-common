...
public class MavenRestHandler extends Application {
    ...
    public void postAsync(@Suspended AsyncResponse ar,
                          ...
                          @HeaderParam("mavenrepo") String mavenRepoPath,
                          @HeaderParam("settings_xml") String settingsXmlPath) throws Exception {
        CompletableFuture<KieCompilationResponse> response = compilerService.build(projectRepo,
                                                                                   mavenRepoPath,
                                                                                   settingsXmlPath);
